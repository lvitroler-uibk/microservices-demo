...
class ClassifyingServiceStub(object):
    """---------------Classifying service----------
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpc.Channel.
        """
        self.ListClassifyings = channel.unary_unary(
                '/hipstershop.ClassifyingService/ListClassifyings',
                request_serializer=demo__pb2.ListClassifyingsRequest.SerializeToString,
                response_deserializer=demo__pb2.ListClassifyingsResponse.FromString,
                )


class ClassifyingServiceServicer(object):
    """---------------Classifying service----------
...
def add_ClassifyingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ListClassifyings': grpc.unary_unary_rpc_method_handler(
                    servicer.ListClassifyings,
                    request_deserializer=demo__pb2.ListClassifyingsRequest.FromString,
                    response_serializer=demo__pb2.ListClassifyingsResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'hipstershop.ClassifyingService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class ClassifyingService(object):
    """---------------Classifying service----------

    """

    @staticmethod
    def ListClassifyings(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/hipstershop.ClassifyingService/ListClassifyings',
            demo__pb2.ListClassifyingsRequest.SerializeToString,
            demo__pb2.ListClassifyingsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
